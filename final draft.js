...
function showInfoWindow(place) {
  ...
  var distanceText = distanceInKm + " km";
  var distanceLink = document.getElementById("place-distance-link");
  distanceLink.textContent = distanceText;
  
  // Create the Google Maps navigation link
  var userLatLng = userMarker.getPosition();
  var googleMapsLink = "https://www.google.com/maps/dir/" + userLatLng.lat() + "," + userLatLng.lng() + "/" + place.geometry.location.lat() + "," + place.geometry.location.lng();
  distanceLink.href = googleMapsLink;
  distanceLink.addEventListener("click", function(event) {
